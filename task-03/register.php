    ...
    <?php
        ...
        if (isset($_POST["submit"])){
            ...
            if (isset($database[$username])){
                ...
                header("Location: /zuri/task-03/index.php");
            }
        }
    ?>
        ...
        <div class="small-container">
            <div class="flex-row">
                <div class="flex-small">
                    ...
                    <form action="/zuri/task-03/register.php" method="post">
        ...
        <div class="small-container">
            <div class="flex-row">
                <div class="flex-small">
                    ...
                    <p><a href="/zuri/task-03/logout.php">Logout</a> to create another account</p>
                </div>
            </div>
        </div>
        ');
